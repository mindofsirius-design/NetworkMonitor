...
namespace NetworkMonitor.ViewModels
{
    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        public StorageService Storage => _storage;  //публична€ копи€
        private readonly ModuleRegistry _moduleRegistry;
        private readonly MonitoringScheduler _scheduler;
        public MonitoringScheduler Scheduler => _scheduler; //публична€ копи€
        ...
        public void UpdateSettings()
        {
            ...
            _scheduler.ResetSchedule(); //—брос расписани€ ping
